...
const cartReducer = (state, action) => {
  ...
  if(action.type === 'REMOVING_ITEM'){
    ...
    const updadedTotalAmount = state.totalAmount - existingItem.price; 
    let updatedItems; 
    ...
    return {
        items: updatedItems, 
        totalAmount: updadedTotalAmount
    }
  }
}
...
const addingItemHandler = (item) => {
  dispatchCartState({type: 'ADDING_ITEM', item: item})
}

const removeItemHandler = (id) => {
  dispatchCartState({type: 'REMOVING_ITEM', id: id})
}
